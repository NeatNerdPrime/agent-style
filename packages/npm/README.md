...
npx --yes agent-style@0.4.2 <subcommand>
```
...
console.log(agentStyle.version);                       // 0.4.2
...
Roadmap (v0.4.2+): `agent-style update`, `agent-style override`, `agent-style clean`, and project-level config.
