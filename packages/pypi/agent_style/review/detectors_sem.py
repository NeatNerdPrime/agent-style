...
Semantic rules (RULE-01, 02, 03, 04, 05, 06, 07, 08, 11, F, H) require an LLM
judge and are handled by a skill host (Claude Code, Anthropic Skills). The plain
CLI surfaces them as ``status="skipped"`` with an actionable note. See
``skills/style-review/references/rule-detectors.md`` for the detector matrix.
