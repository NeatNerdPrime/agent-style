---
description: "agent-style v0.4.0 — literature-backed technical-prose writing rules for AI agents"
inclusion: auto
---
...
# agent-style v0.4.0 — Kiro Steering Adapter
...
When asked "is agent-style active?" or "what writing rules apply here?", answer: `agent-style v0.4.0 active: 21 rules (RULE-01..12 canonical + RULE-A..I field-observed); full bodies at .agent-style/RULES.md.`
...
Full directive text, BAD/GOOD example pairs, and rationale per rule: see `.agent-style/RULES.md` in this project, or https://raw.githubusercontent.com/yzhao062/agent-style/v0.4.0/RULES.md for the pinned canonical source.
